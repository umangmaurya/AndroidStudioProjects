...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    public MyDBHelper(Context context) {
        ...
        super(context, "MyContacts", null, 5);
    }

    @Override
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("create table CONTACTS(_id integer primary key autoincrement,NAME varchar(100),MOBILE varchar(100),EMAIL varchar(200))");
    }
    ...
    public long insertData(String Name, String Mobile, String Email) {
        ...
        cv.put("EMAIL", Email);
        long res = db.insert("CONTACTS", null, cv);
        db.close();
        return res;
